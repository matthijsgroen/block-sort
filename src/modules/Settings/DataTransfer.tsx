    ...
    <div className="flex flex-col gap-4 mb-4">
      ...
      {supportsEncryption ? (
        <>
          ...
          <p className="text-xs">
            You can export your game data as an image. This image can be used to
            import your game data into another instance of the game. The export
            is valid for {DATA_VALIDITY_TIME} minutes, and needs to be imported
            into the same version of the game.
          </p>
          {!startDownload && (
            <TransparentButton
              onClick={() => {
  ...
  return (
    <div>
      <a
        ref={anchorRef}
        href={resolved}
        download={`gamestate-${new Date().getTime()}.png`}
        className={clsx(
          "inline-block rounded-full border border-black p-2 shadow-md",
      ...
      <p className="text-sm pt-2">
        This image contains all your game data. You can download it and upload
        it to your new game instance (on another device or this one). The image
        will be valid for {DATA_VALIDITY_TIME} minutes.
      </p>
    </div>
  );
};
