...
} from "@/game/level-types/oversized";
import {
  getSpecial1Settings,
  getSpecial2Settings,
  getSpecial3Settings,
...
export const producers: Producer[] = [
  ...
  { name: "Hot", producer: getHotSettings },
  { name: "Hot2", producer: getHot2Settings },
  { name: "Hot3", producer: getHot3Settings },
  ...
  { name: "Oversized2", producer: getOversized2Settings }
];
